...
#ifndef RTW_HEADER_Lab2a_circle_h_
#define RTW_HEADER_Lab2a_circle_h_
#include <math.h>
#include <float.h>
#include <string.h>
#include <stddef.h>
#ifndef Lab2a_circle_COMMON_INCLUDES_
# define Lab2a_circle_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Lab2a_circle_COMMON_INCLUDES_ */

#include "Lab2a_circle_types.h"
...
typedef struct {
  ...
  real_T ref_cur;                      /* '<Root>/traj generation2' */
  real_T ref_dcur;                     /* '<Root>/traj generation2' */
  real_T ref_cur_g;                    /* '<Root>/traj generation1' */
  real_T ref_dcur_l;                   /* '<Root>/traj generation1' */
  real_T ref_cur_c;                    /* '<Root>/traj generation' */
  real_T ref_dcur_a;                   /* '<Root>/traj generation' */
...
struct P_Lab2a_circle_T_ {
  ...
  real_T Ts_traj;                      /* Variable: Ts_traj
                                        ...
                                        */
  real_T joint_pos1_circle[185];       /* Variable: joint_pos1_circle
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T joint_pos2_circle[186];       /* Variable: joint_pos2_circle
                                        * Referenced by: '<Root>/Constant4'
                                        */
  real_T joint_pos3_circle[184];       /* Variable: joint_pos3_circle
  ...
  real_T On_Value;                     /* Expression: 1
                                        ...
                                        */
  real_T Constant2_Value[3];           /* Expression: motor_vel_circle(:,1)
                                        * Referenced by: '<Root>/Constant2'
                                        */
  real_T Gain_Gain;                    /* Expression: pi/180
                                        * Referenced by: '<S1>/Gain'
                                        */
  real_T Constant5_Value[3];           /* Expression: motor_vel_circle(:,2)
                                        * Referenced by: '<Root>/Constant5'
                                        */
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        * Referenced by: '<S2>/Gain1'
                                        */
  real_T Constant8_Value[3];           /* Expression: motor_vel_circle(:,3)
...
extern P_Lab2a_circle_T Lab2a_circle_P;

/* Block signals (auto storage) */
extern B_Lab2a_circle_T Lab2a_circle_B;

/* Block states (auto storage) */
extern DW_Lab2a_circle_T Lab2a_circle_DW;

/* Model entry point functions */
extern void Lab2a_circle_initialize(void);
extern void Lab2a_circle_output(void);
extern void Lab2a_circle_update(void);
extern void Lab2a_circle_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Lab2a_circle_T *const Lab2a_circle_M;
 ...
 *
 * '<Root>' : 'Lab2a_circle'
 * '<S1>'   : 'Lab2a_circle/MOTOR A'
 * '<S2>'   : 'Lab2a_circle/MOTOR B'
 * '<S3>'   : 'Lab2a_circle/MOTOR C'
 * '<S4>'   : 'Lab2a_circle/PD control1'
 * '<S5>'   : 'Lab2a_circle/PD control2'
 * '<S6>'   : 'Lab2a_circle/PD control3'
 * '<S7>'   : 'Lab2a_circle/timer w// reset'
 * '<S8>'   : 'Lab2a_circle/traj generation'
 * '<S9>'   : 'Lab2a_circle/traj generation1'
 * '<S10>'  : 'Lab2a_circle/traj generation2'
 * '<S11>'  : 'Lab2a_circle/velocity filter'
 * '<S12>'  : 'Lab2a_circle/velocity filter  '
 * '<S13>'  : 'Lab2a_circle/velocity filter     '
 * '<S14>'  : 'Lab2a_circle/MOTOR A/Motor'
 * '<S15>'  : 'Lab2a_circle/MOTOR B/Motor1'
 * '<S16>'  : 'Lab2a_circle/MOTOR C/Motor2'
 * '<S17>'  : 'Lab2a_circle/velocity filter/IO Delay'
 * '<S18>'  : 'Lab2a_circle/velocity filter/Input Delay'
 * '<S19>'  : 'Lab2a_circle/velocity filter/Output Delay'
 * '<S20>'  : 'Lab2a_circle/velocity filter  /IO Delay'
 * '<S21>'  : 'Lab2a_circle/velocity filter  /Input Delay'
 * '<S22>'  : 'Lab2a_circle/velocity filter  /Output Delay'
 * '<S23>'  : 'Lab2a_circle/velocity filter     /IO Delay'
 * '<S24>'  : 'Lab2a_circle/velocity filter     /Input Delay'
 * '<S25>'  : 'Lab2a_circle/velocity filter     /Output Delay'
 */
#endif                                 /* RTW_HEADER_Lab2a_circle_h_ */
